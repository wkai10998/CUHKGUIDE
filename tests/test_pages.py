...
class PageRenderingTestCase(unittest.TestCase):
    ...
    def test_programs_page_keeps_lookup_behavior_with_directory_style_copy(self):
        ...
        self.assertIn("按学院筛选", html)
        self.assertIn('<option value="全部" selected>全部</option>', html)
        self.assertIn('<option value="文学院">文学院</option>', html)
        self.assertIn('<option value="商学院">商学院</option>', html)
        self.assertIn('<option value="教育学院">教育学院</option>', html)
        self.assertIn('<option value="工学院">工学院</option>', html)
        self.assertIn('<option value="跨学院">跨学院</option>', html)
        self.assertIn('<option value="法学院">法学院</option>', html)
        self.assertIn('<option value="医学院">医学院</option>', html)
        self.assertIn('<option value="理学院">理学院</option>', html)
        self.assertIn('<option value="社科学院">社科学院</option>', html)
        self.assertIn("tocu-program-title__zh", html)
        self.assertIn("tocu-program-title__en", html)
